...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Ramakrishna Vaddar — Full-Stack Developer" },
      {
        name: "description",
        content:
          "Portfolio of Ramakrishna Vaddar, full-stack developer building fast, accessible web products.",
      },
      { name: "author", content: "Ramakrishna Vaddar" },
      { property: "og:site_name", content: "Ramakrishna Vaddar" },
      ...
      <div className="flex min-h-screen flex-col">
        ...
        <footer className="border-t border-border">
          <div className="mx-auto flex max-w-6xl flex-col gap-2 px-5 py-8 text-sm text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
            <p>© {new Date().getFullYear()} Ramakrishna Vaddar</p>
